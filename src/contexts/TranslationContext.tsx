...
const translations = {
  en: {
    ...
    'projects.work': 'Work',
    'projects.subtitle': 'A selection of my best projects and website templates that showcase modern design and functionality for construction and real estate businesses.',
    ...
    'contact.locationValue': 'El Jadida, Maroc',
  ...
  fr: {
    ...
    'projects.subtitle': 'Une sélection de mes meilleurs projets et modèles de sites web qui présentent un design moderne et des fonctionnalités pour les entreprises de construction et d\'immobilier.',
